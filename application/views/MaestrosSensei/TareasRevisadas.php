 ...
 <div class="col-lg-12 col-md-12">
  	<div class="card">
  		<div class="header">
  			<h4 class="title">Tareas Calificadas</h4>
  		</div>
  		<div class="content">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="ID_Aula">
                ...
                <?php foreach ($Grupos->result() as $key) { ?>
                  <option value="<?= $key->Grup_ID ?>"><?= $key->Grup_Nombre ?></option>
               <?php } ?>
            </select>
          </div>
        </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              <div class="form-group">
                <button type="button" class="btn btn-success" onclick="Calificar()">Calificar</button>
              </div>
            </div>
