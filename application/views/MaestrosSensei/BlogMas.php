	...
	<div class="content">
		...
		<div class="row">
			<div class="col-lg-8 col-md-8">
			 ...
			 <form action="<?= base_url('Maestros/GuardaComentarioBlog') ?>" method="post">
              ...
              <input type="text" class="hide" name="imagenPerfil" value="<?= $this->session->Avatar ?>">
               <p>Comentar</p>
                <textarea name="Comentario" class="form-control" style="border: 2px solid #990000;" placeholder="Escribe aqui tu comentario" rows="3"></textarea>
                <br>
