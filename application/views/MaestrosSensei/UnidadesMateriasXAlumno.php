<div class="col-lg-12 col-md-12">
	<div class="card">
		<div class="header">
      <h4 class="title">Alumno: <?= $Nombre_Alumno ?></h4><br>
      <?php 
      foreach ($Info_Materia->result() as $key) {
        echo "<h5 class='title'>Aula: ".$key->Grup_Nombre."</h5>";
        echo "<h5 class='title'>Materia: ".$key->Materia_Nombre."</h5>";
        echo "<h5 class='title'>Unidad: ".$key->Unidad_Descripcion."</h5>";
      ...
      ?>
        ...
        <table class="table table-striped table-hover table-sm">
          ...
          <tbody>
              <?php foreach ($EntregaronTarea->result() as $Fila ): ?>
                <tr>
                  ...
                  <td><a href="<?= base_url('Maestros/RevisarDocumento/').$Fila->Archi_ID ?>" target="_blank" type="button" class="btn btn-primary">Ver</a></td>
