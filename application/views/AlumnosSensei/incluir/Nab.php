		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">
					<img src="<?= base_url($this->session->Avatar) ?>" class="img-circle" width="30" height="30" alt="..." />
				</a>
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li>
								<a href="#" type="button" data-toggle="modal" data-target="#ModalUnion" data-backdrop="false">Unirme a un aula</a>
							</li>
							<li>
								<a href="<?= base_url('Alumnos/CerrarSesion') ?>">Salir</a>
							</li>
						</ul>
					</li>
				</ul>
